...
insert into USER (id, username, password, email) values (3, 'admin_a', '1',  'some@mail.com')
insert into USER (id, username, password, email) values (4, 'padmin_pa', '1', 'some@mail.com')
